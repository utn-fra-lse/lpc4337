...
#ifdef USE_USB0
#define CIAA_USB_BASE           LPC_USB0_BASE
#define CIAA_USB                LPC_USB0
#define CIAA_USB_IRQ            USB0_IRQn
#define USB_IRQHandler          USB0_IRQHandler
#else
#define CIAA_USB_BASE           LPC_USB1_BASE
#define CIAA_USB                LPC_USB1
#define CIAA_USB_IRQ            USB1_IRQn

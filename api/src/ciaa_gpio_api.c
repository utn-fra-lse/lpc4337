...
pin_t RXD1 = { 0, 0, 0, 0, SCU_MODE_FUNC0 };
pin_t TX_EN = { 0, 1, 0, 1, SCU_MODE_FUNC0 };
pin_t RXD0 = { 1, 15, 0, 2, SCU_MODE_FUNC0 };
pin_t CRS_DV = { 1, 16, 0, 3, SCU_MODE_FUNC0 };
pin_t MDIO = { 1, 17, 0, 12, SCU_MODE_FUNC0 };
pin_t TXD0 = { 1, 18, 0, 13, SCU_MODE_FUNC0 };
pin_t TXD1 = { 1, 20, 0, 15, SCU_MODE_FUNC0 };
pin_t MDC = { 7, 7, 3, 15, SCU_MODE_FUNC0 };

pin_t RS232_TXD = { 2, 3, 5, 3, SCU_MODE_FUNC4 };
pin_t RS232_RXD = { 2, 4, 5, 4, SCU_MODE_FUNC4 };

pin_t RS485_DIR = { 6, 2, 3, 1, SCU_MODE_FUNC0 };
pin_t RS485_TXD = { 9, 5, 5, 18, SCU_MODE_FUNC4 };
pin_t RS485_RXD = { 9, 6, 4, 11, SCU_MODE_FUNC0 };

pin_t CAN_RD = { 3, 1, 5, 8, SCU_MODE_FUNC4 };
pin_t CAN_TD = { 3, 2, 5, 9, SCU_MODE_FUNC4 };

pin_t SPI_MISO = { 1, 3, 0, 10, SCU_MODE_FUNC0 };
pin_t SPI_MOSI = { 1, 4, 0, 11, SCU_MODE_FUNC0 };
